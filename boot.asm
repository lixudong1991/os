...
global _monitor,_mwait,cr0_data,set_cr0data,cr4_data,set_cr4data,pre_mtrr_change,post_mtrr_change,spinlock,unlock,sysInChar,sysOutChar,ps2Controllerinit,wait60PortToread,wait60_64PortTowirte
extern bootparam
